...
type Score {
  ...
  type Query {
    ...
    getTaggedCollages(cursor: ID, limit: Int): CollagePagination
...
type ExperienceDetails {
  ...
  type Mutation {
    ...
    validatePhoneNumber(phoneNumber: String): StandardResponse
    ...
    updatePassword(currentPassword: String, newPassword: String): StandardResponse
    ...
    markCollageViewedAndGetCollageById(collageId: ID!): CollageResponse
