...
export default function CameraOnboarding() {
  ...
  return (
    <View style={layoutStyles.wrapper}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={require("../../../assets/onboarding/camera-onboarding.png")}
          style={styles.image}
        />
        {/* Gradient Overlay */}
        <LinearGradient
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={styles.subtitle}>
            Snap moments, capture experiences, and keep memories forever.
          </Text>
        </View>
        ...
        <View style={styles.progressContainer}>
          {[...Array(4)].map((_, index) => (
            <View
              ...
              style={[
                styles.dot,
                index === 1 && styles.activeDot, // Highlight the second dot
              ]}
            />
          ))}
        </View>
        ...
        <AuthenticationButton
          ...
          width="85%"
          text="Next"
          onPress={() => navigation.navigate("ShareOnboarding")}
        />
      </View>
    </View>
  );
